...
//This c program reverses the bit x = 0x01FF01FF   and prints out the orginal bit and reversed bit.
...
main:                                                        
                ...
                mov x_val,  0x01FF01FF                     // Initialzie x_val with the orginal value 
