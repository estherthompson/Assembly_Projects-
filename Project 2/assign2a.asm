//Filename: assign2a.asm 
//Date: October 5th 2023 
//Description:
// An ARMv8 assembly language program the implements a given c program. 
//This c program reverses the bit x = 0x07FC07FC and prints out the orginal bit and reversed bit.
// The assembly program will do the same except it print the orginal , reversed in hexadecimal 
// and then the orginal and reversed number in binary for the gbd
...
main:                                                        
                ...
                mov x_val,  0x07FC07FC                   // Initialzie x_val with the orginal value 
